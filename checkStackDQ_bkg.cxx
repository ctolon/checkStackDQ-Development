...
int checkStackDQ_bkg()
{
	...
	std::cout << "                             Usage of this macro for background events"                       << '\n';
	std::cout << "============================================================================================" << '\n';
	...
	std::cout << "============================================================================================" << '\n';
	std::cin >> leptonPDG;
	//if(leptonPDG != 13 || leptonPDG != 11){printf("Your LeptonPDG selection is wrong!");}
	...
	Int_t etaMin, etaMax;      etaMin = -5; etaMax = 5;
	Int_t phiMin, phiMax;      phiMin = -6; phiMax = 6;
	Int_t thetaMin, thetaMax;  thetaMin = -5; thetaMax = 6;
	...
	TH1F *histEtaJpsiPrompt = new TH1F("EtaJpsiPromptBeforeCuts",";#eta;Entries",100,etaMin,etaMax);
	TH1F *histThetaJpsiPrompt = new TH1F("ThetaJpsiPromptBeforeCuts",";#theta (rad.);Entries",100,thetaMin,thetaMax);
	TH1F *histPhiJpsiPrompt = new TH1F("PhiJpsiPromptBeforeCuts",";#phi (rad.);Entries",100,phiMin,phiMax);
	// Psi(2s)
	...
	TH1F *histEtaPsi2sPrompt = new TH1F("EtaPsi2sPromptBeforeCuts",";#eta;Entries",100,etaMin,etaMax);
	TH1F *histThetaPsi2sPrompt = new TH1F("ThetaPsi2sPromptBeforeCuts",";#theta (rad.);Entries",100,thetaMin,thetaMax);
	TH1F *histPhiPsi2sPrompt = new TH1F("PhiPsi2sPromptBeforeCuts",";#phi (rad.);Entries",100,phiMin,phiMax);
	...
	TH1F *histEtaJpsiPromptAfterCuts = new TH1F("EtaJpsiPromptAfterCuts",";#eta;Entries",100,etaMin,etaMax);
	TH1F *histThetaJpsiPromptAfterCuts = new TH1F("ThetaJpsiPromptAfterCuts",";#theta (rad.);Entries",100,thetaMin,thetaMax);
	TH1F *histPhiJpsiPromptAfterCuts = new TH1F("PhiJpsiPromptAfterCuts",";#phi (rad.);Entries",100,phiMin,phiMax);
	// Psi(2s)
	...
	TH1F *histEtaPsi2sPromptAfterCuts = new TH1F("EtaPsi2sPromptAfterCuts",";#eta;Entries",100,etaMin,etaMax);
	TH1F *histThetaPsi2sPromptAfterCuts = new TH1F("ThetaPsi2sPromptAfterCuts",";#theta (rad.);Entries",100,thetaMin,thetaMax);
	TH1F *histPhiPsi2sPromptAfterCuts = new TH1F("PhiPsi2sPromptAfterCuts",";#phi (rad.);Entries",100,phiMin,phiMax);
	...
	TH1F *histEtaJpsiNonPrompt = new TH1F("EtaJpsiNonPromptBeforeCuts",";#eta (rad.);Entries",100,etaMin,etaMax);
	TH1F *histThetaJpsiNonPrompt = new TH1F("ThetaJpsiNonPromptBeforeCuts",";#theta (rad.);Entries",100,thetaMin,thetaMax);
	TH1F *histPhiJpsiNonPrompt = new TH1F("PhiJpsiNonPromptBeforeCuts",";#phi (rad.);Entries",100,phiMin,phiMax);
	// Psi(2s)
	...
	TH1F *histEtaPsi2sNonPrompt = new TH1F("EtaPsi2sNonPromptBeforeCuts",";#eta;Entries",100,etaMin,etaMax);
	TH1F *histThetaPsi2sNonPrompt = new TH1F("ThetaPsi2sNonPromptBeforeCuts",";#theta (rad.);Entries",100,thetaMin,thetaMax);
	TH1F *histPhiPsi2sNonPrompt = new TH1F("PhiPsi2sNonPromptBeforeCuts",";#phi (rad.);Entries",100,phiMin,phiMax);
	...
	TH1F *histEtaJpsiNonPromptAfterCuts = new TH1F("EtaJpsiNonPromptAfterCuts",";#eta;Entries",100,etaMin,etaMax);
	TH1F *histThetaJpsiNonPromptAfterCuts = new TH1F("ThetaJpsiNonPromptAfterCuts",";#theta (rad.);Entries",100,thetaMin,thetaMax);
	TH1F *histPhiJpsiNonPromptAfterCuts = new TH1F("PhiJpsiNonPromptAfterCuts",";#phi (rad.);Entries",100,phiMin,phiMax);
	// Psi(2s)
	...
	TH1F *histEtaPsi2sNonPromptAfterCuts = new TH1F("EtaPsi2sNonPromptAfterCuts",";#eta;Entries",100,etaMin,etaMax);
	TH1F *histThetaPsi2sNonPromptAfterCuts = new TH1F("ThetaPsi2sNonPromptAfterCuts",";#theta (rad.);Entries",100,thetaMin,thetaMax);
	TH1F *histPhiPsi2sNonPromptAfterCuts = new TH1F("PhiPsi2sNonPromptAfterCuts",";#phi (rad.);Entries",100,phiMin,phiMax);

	/// define histos for other background particles before cuts

	TH1F *histPtPairUnknown   = new TH1F("PtPairUnknownPromptBeforeCuts",";p_{T}(GeV/c);Entries",100,0.,20.);
	TH1F *histMassPairUnknown = new TH1F("MassUnknownPromptBeforeCuts",";m_{ll}(GeV/c^{2});Entries",5./0.02,0.,5.);
	TH1F *histYUnknown        = new TH1F("YUnknownPromptBeforeCuts",";y;Entries",100,rapMin,rapMax);
	TH1F *histPtUnknown       = new TH1F("PtUnknownPromptBeforeCuts",";p_{T}(GeV/c);Entries",100,0.,15.);
	TH1F *histEtaUnknown      = new TH1F("EtaUnknownPromptBeforeCuts",";#eta;Entries",100,etaMin,etaMax);
	TH1F *histThetaUnknown    = new TH1F("ThetaUnknownPromptBeforeCuts",";#theta (rad.);Entries",100,thetaMin,thetaMax);
	TH1F *histPhiUnknown      = new TH1F("PhiUnknownPromptBeforeCuts",";#phi (rad.);Entries",100,phiMin,phiMax);

	/// define histos for other background particles after cuts

	TH1F *histPtPairUnknownAfterCuts   = new TH1F("PtPairUnknownAfterCuts",";p_{T}(GeV/c);Entries",100,0.,20.);
	TH1F *histMassPairUnknownAfterCuts = new TH1F("MassUnknownAfterCuts",";m_{ll}(GeV/c^{2});Entries",5./0.02,0.,5.);
	TH1F *histYUnknownAfterCuts        = new TH1F("YUnknownAfterCuts",";y;Entries",100,rapMin,rapMax);
	TH1F *histPtUnknownAfterCuts       = new TH1F("PtUnknownAfterCuts",";p_{T}(GeV/c);Entries",100,0.,15.);
	TH1F *histEtaUnknownAfterCuts      = new TH1F("EtaUnknownAfterCuts",";#eta;Entries",100,etaMin,etaMax);
	TH1F *histThetaUnknownAfterCuts    = new TH1F("ThetaUnknownPromptAfterCuts",";#theta (rad.);Entries",100,thetaMin,thetaMax);
	TH1F *histPhiUnknownAfterCuts      = new TH1F("PhiUnknownPromptAfterCuts",";#phi (rad.);Entries",100,phiMin,phiMax);
	...
	histPtPairUnknown->Sumw2();
	histPtUnknown->Sumw2();
	histPtPairUnknownAfterCuts->Sumw2();
	histPtUnknownAfterCuts->Sumw2();
	...
	Double_t m1, m2;
	Double_t px, py;
	Double_t ptMoth, yMoth, etaMoth, pMoth, phiMoth, thetaMoth;
	...
	for (int eventID = 0; eventID < mcbr->GetEntries(); ++eventID) {
		...
		for (auto& t : *mctracks) {
			...
			Bool_t isJpsi         =  TMath::Abs(t.GetPdgCode()) == mothPDG[0];
			Bool_t isPsi2s        =  TMath::Abs(t.GetPdgCode()) == mothPDG[1];
			o2::MCTrack *lepton=0x0; o2::MCTrack *antilepton=0x0;
			Int_t idMoth = t.getMotherTrackId();
			Bool_t isPrompt = idMoth <= 0 && (isJpsi == kTRUE || isPsi2s == kTRUE)  ? kTRUE : kFALSE;
			...
			//// fill non prompt
				...
				histPtPairJpsiNonPrompt->Fill(ptPair);
			...
			//// fill other background particles
				...
				histPtPairUnknown->Fill(ptPair);
				histMassPairUnknown->Fill(invMassPair);
				histPtUnknown->Fill(ptMoth);
				histYUnknown->Fill(yMoth);
				histEtaUnknown->Fill(etaMoth);
				histThetaUnknown->Fill(thetaMoth);
				histPhiUnknown->Fill(phiMoth);
				histOrigin->Fill(4.5);
			}
			...
			//// fill other background particles
				...
				histPtPairUnknownAfterCuts->Fill(ptPair);
				histMassPairUnknownAfterCuts->Fill(invMassPair);
				histPtUnknownAfterCuts->Fill(ptMoth);
				histYUnknownAfterCuts->Fill(yMoth);
				histEtaUnknownAfterCuts->Fill(etaMoth);
				histThetaUnknownAfterCuts->Fill(thetaMoth);
				histPhiUnknownAfterCuts->Fill(phiMoth);
	...
	histPtPairUnknown->Write();
	histMassPairUnknown->Write();
	histPtUnknown->Write();
	histYUnknown->Write();
	histEtaUnknown->Write();
	histThetaUnknown->Write();
	histPhiUnknown->Write();
